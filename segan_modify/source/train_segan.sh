...
# CUDA_VISIBLE_DEVICES="1,2,3" python main.py --init_noise_std 0. --save_path ../../segan_v1.1\
#                                           --init_l1_weight 100. --batch_size 100 --g_nl prelu \
#                                           --save_freq 50 --preemph 0.95 --epoch 86 --bias_deconv True \
#                                           --bias_downconv True --bias_D_conv True --e2e_dataset ../../data/segan.tfrecords

CUDA_VISIBLE_DEVICES="0" python main.py --init_noise_std 0. --save_path ../../../segan_v1.1\
                                          --init_l1_weight 100. --batch_size 100 --g_nl prelu \
                                          --save_freq 50 --preemph 0.95 --epoch 1 --bias_deconv True \
                                          --bias_downconv True --bias_D_conv True --e2e_dataset ../../../data/segan.tfrecords
